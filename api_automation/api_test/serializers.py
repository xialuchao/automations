...
from api_test.models import Project, ProjectDynamic, ProjectMember, GlobalHost, ApiGroupLevelFirst, \
    ApiInfo, CaseInfo, APIRequestHistory, ApiOperationHistory, AutomationGroupLevelFirst, \
...
class CaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CaseInfo
        fields = ("id", "name", "httpType", "requestType", "caseAddress", "requestParameterType")
...
class ApiInfoDeserializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'httpType', 'requestType', 'apiAddress', 'status', 'data', 'description')
